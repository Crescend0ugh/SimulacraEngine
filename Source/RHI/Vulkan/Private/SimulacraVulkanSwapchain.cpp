...
VulkanSwapchain::VulkanSwapchain(VkInstance InInstance, VulkanDevice *InDevice, void *InWindowHandle) {
    ...
    SVulkanPlatform::CreateSurface(InWindowHandle, &Surface, InInstance);
...
VkSurfaceFormatKHR VulkanSwapchain::ChooseSurfaceFormat() {
    ...
    //TODO Pass actual physical device
...
VkExtent2D VulkanSwapchain::ChooseExtent(VkSurfaceCapabilitiesKHR InCapabilities) {
    uint32 Width, Height;
...
VkSurfaceTransformFlagBitsKHR VulkanSwapchain::ChoosePreTransform(VkSurfaceCapabilitiesKHR InCapabilities) {
...
VkCompositeAlphaFlagBitsKHR VulkanSwapchain::ChooseAlphaCompositingMode(VkSurfaceCapabilitiesKHR InCapabilities) {
...
uint32 VulkanSwapchain::ChooseMinImageCount(VkSurfaceCapabilitiesKHR InCapabilities, uint32 DesiredMinImageCount) {
