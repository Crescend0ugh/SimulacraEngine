//
// Created by Adithya Somashekhar on 10/6/24.
//
#pragma once
...
namespace math
{
    static constexpr simd::float3 add( const simd::float3& a, const simd::float3& b )
    {
        return { a.x + b.x, a.y + b.y, a.z + b.z };
    }

    static constexpr simd_float4x4 makeIdentity()
    {
        using simd::float4;
