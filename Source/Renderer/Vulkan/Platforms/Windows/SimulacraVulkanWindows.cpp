...
#include "SimulacraVulkanWindows.h"

void SimulacraVulkanWindows::CreateSurface(void *InWindowHandle, VkSurfaceKHR *OutSurface, VkInstance InInstance)
{
    VkWin32SurfaceCreateInfoKHR Win32SurfaceCreateInfo{};
    SetZeroVulkanStruct(Win32SurfaceCreateInfo, VK_STRUCTURE_TYPE_WIN32_SURFACE_CREATE_INFO_KHR);

    Win32SurfaceCreateInfo.hinstance = nullptr;
